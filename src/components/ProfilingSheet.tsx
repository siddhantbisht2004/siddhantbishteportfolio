...
const MovieReviewQuestion = ({ number, question }: { number: number, question: string }) => {
  ...
  return (
    <Card className="mb-6 border-primary/20 hover:border-primary/50 transition-all">
      ...
      <CardContent className="space-y-4">
        <div>
          <Label htmlFor={`movie_q${number}-answer`}>Your Answer:</Label>
          <textarea
            id={`movie_q${number}-answer`}
            value={answer}
            onChange={handleAnswerChange}
            placeholder="Type your answer here..."
            className="flex min-h-28 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
...
const questions = [
  ...
  { id: 11, text: "Describe yourself as an individual in 5 lines." },
  ...
  { id: 20, text: "So finally, tell us something more about yourself or introduce yourself." },
];

const movieQuestions = [
  { id: 1, text: "Your favourite dialogue and why?" },
  { id: 2, text: "Your personal Review." },
  { id: 3, text: "Learning to take away from the movie." },
  { id: 4, text: "Related concepts you've learned in the classroom." },
];
  ...
  return (
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4">
        <Tabs defaultValue="profiling" className="mb-12">
          <TabsList className="grid w-full max-w-md mx-auto grid-cols-2">
            <TabsTrigger value="profiling">Profiling Sheet</TabsTrigger>
            <TabsTrigger value="movie">Movie Review</TabsTrigger>
          </TabsList>
          
          <TabsContent value="profiling" className="mt-8">
          ...
          <TabsContent value="movie" className="mt-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-2">
                <Film className="inline-block mr-2 text-primary" />
                Movie Review: 12 Angry Men
              </h2>
              <p className="text-muted-foreground mb-6">Share your thoughts on this classic film</p>
              
              <div className="max-w-3xl mx-auto bg-secondary/20 p-6 rounded-lg border border-secondary/30 mb-8">
                <div className="flex flex-col md:flex-row gap-6 items-center">
                  <div className="aspect-[2/3] w-48 bg-muted rounded-md overflow-hidden">
                    <img 
                  ...
                  <div className="text-left">
                    <h3 className="text-xl font-medium mb-2">12 Angry Men (1957)</h3>
                    <div className="flex items-center mb-2">
                      ...
                      <span className="ml-2 text-sm">8.9/10</span>
                    </div>
                    <p className="text-sm text-foreground/80">
                      A jury of 12 men must decide the fate of an 18-year-old defendant charged with murder in the first degree. 
                      What begins as an open-and-shut case soon becomes a detective story and mini-drama of each juror's prejudices and preconceptions.
                    </p>
                    <div className="mt-3">
                      <span className="inline-block bg-primary/10 text-primary text-xs px-2 py-1 rounded mr-2 mb-2">Drama</span>
                      <span className="inline-block bg-primary/10 text-primary text-xs px-2 py-1 rounded mr-2 mb-2">Crime</span>
                      <span className="inline-block bg-primary/10 text-primary text-xs px-2 py-1 rounded mr-2 mb-2">Courtroom</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              <div className="flex justify-center pt-8">
                <Button 
                  size="lg"
                  onClick={() => toast.success("Movie review responses saved!")}
                  className="px-8"
                >
                  Save Movie Review
                </Button>
